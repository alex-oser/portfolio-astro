...
export const Header = ({ siteTitle = '' }: { siteTitle?: string }) => {
  ...
  const handleNavigation = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>, target: string) => {
    ...
    <Root className={classes.root}>
      <div className={classes.headerContents}>
        ...
        <div style={{ display: 'flex', alignSelf: 'center' }}>
          ...
          <a href="/#blog" className={classes.link} onClick={(e) => handleNavigation(e, 'blog')}>
            Blog
          </a>
          <a
            href="/#snippets"
